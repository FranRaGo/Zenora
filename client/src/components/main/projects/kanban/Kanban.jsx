                ...
                <div className="container-projects-list">
                    {projectData.length > 0 ? (
                        projectData.map((pr, index) => (
                            <div key={pr.id} className="kanban-list">
                                ...
                                {pr.isOpen && (
                                    <div className="kanbanColumn-container">
                                        <KanbanColumns status={0} project={pr} users={pr.users} user={user} />
                                        <KanbanColumns status={1} project={pr} users={pr.users} user={user} />
                                        <KanbanColumns status={2} project={pr} users={pr.users} user={user} />
                                    </div>
                                )}
                            </div>
                        ))) : (
