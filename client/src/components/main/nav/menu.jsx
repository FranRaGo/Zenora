    ...
    return (
        <div className={status ? "div-perfil" : "div-perfil-colapsed"} >
                <button onClick={() => setActiveSection("home")} className={`${status ? "btn-nav" : "btn-nav-colapsed"} ${activeSection === "home" ? "active-menu" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill={activeSection === "home" ? "#fafafa20" : "none"} stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
                ...
                <button onClick={() => setActiveSection("projects")} className={`${status ? "btn-nav" : "btn-nav-colapsed"} ${activeSection === "projects" ? "active-menu" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill={activeSection === "projects" ? "#fafafa20" : "none"} viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor">
                ...
                <button onClick={() => setActiveSection("chat")} className={`${status ? "btn-nav" : "btn-nav-colapsed"} ${activeSection === "chat" ? "active-menu" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill={activeSection === "chat" ? "#fafafa20" : "none"} viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor">
                ...
                <button onClick={() => setActiveSection("employees")} className={`${status ? "btn-nav" : "btn-nav-colapsed"} ${activeSection === "employees" ? "active-menu" : ""}`}>
                    <svg xmlns="http://www.w3.org/2000/svg" fill={activeSection === "employees" ? "#fafafa20" : "none"} viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor">
