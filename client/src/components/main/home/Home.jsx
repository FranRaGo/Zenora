    ...
    if (isMobile) {
        return (
            <div className="content-container">
                <h1 className="home-title">{space?.name}</h1>
                        ...
                        <div className="home-section-projects">
                            ...
                            <div className="home-project-list">
                                ...
                                <div className="home-project-empty">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1" stroke="currentColor" width="30" height="30">
