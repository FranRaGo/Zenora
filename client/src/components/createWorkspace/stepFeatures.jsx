...
const Moduls = ({ nameSpace, goBack, planRequired, idUser }) => {
        ...
        const getModuls = async () => {
            try {
                ...
                if (res.ok) {
                    ...
                    //lo hago para poner en selected los modulos gratis
                    const freeModules = data
                        .filter(mod => mod.plan_id === 1)
                        .map(mod => ({
                            id: mod.id,
                            name: mod.name,
                            plan_id: mod.plan_id,
