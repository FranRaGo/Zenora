...
const Menu = ({ status }) => {
    ...
    return (
        <div className={status ? "div-perfil" : "div-perfil-colapsed"} >
                <button className={status ? "btn-nav" : "btn-nav-colapsed"} >
                ...
                <button className={status ? "btn-nav" : "btn-nav-colapsed"}>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1" d="M12 4v16m8-8H4" color="currentColor"/>
                    </svg>
                    {status ? <p>Add</p> : ""}
                </button>
                <button className={status ? "btn-nav" : "btn-nav-colapsed"}>
